...
> **歷史快照（2026-07-07）**：本檔保留當時 18 卡版本的 Demo Kit 與統計，不再代表最終繳交口徑。
> 現行完整事實來源請使用 `08_COMPETITION_AI_USAGE_AND_WORKFLOW.md`，PPT 草稿使用 `09`／`10`。
...
- [x] SFX 已補齊並接入；現況見 `Docs/SFX_TODO.md`（此項於歷史快照後完成）。
