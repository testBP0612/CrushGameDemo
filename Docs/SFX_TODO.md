...
| 類型 | 檔案 | 狀態 |
|---|---|---|
| BGM | `Assets/final/audio/bgm_main.ogg` | 已接檔，設定讀 `Data/audio.json > bgm` |
| 虎爺事件 BGM | `Assets/final/audio/bgm_huye.ogg` | ✅ 已接檔，設定讀 `Data/audio.json > event_bgm.huye` |
...
| `huye_appear` | 虎爺落地衝擊（卡 24 追加、卡 26 統一命名） | `sfx_huye_appear.ogg` | ✅ 已接檔；2026-07-16 修正非 UTF-8 metadata |
| `huye_divine_reveal` | 虎爺慢速顯形起始（神明降臨感） | `sfx_huye_divine_reveal.ogg` | ✅ 已接檔 |
| `coin_burst` | 怪物死亡金幣噴發實際開始 | `sfx_coin_burst.ogg` | ✅ 已接檔（2026-07-16，任務 25 契約校正） |
| `huye_coin_burst` | 虎爺獎勵金幣噴發實際開始 | `sfx_huye_coin_burst.ogg` | ✅ 已接檔（2026-07-16，任務 25 契約校正） |
